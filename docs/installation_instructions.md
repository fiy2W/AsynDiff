...
### Linux
Execute the following lines whenever you run nnSeq2Seq:
```sh
export nnSeq2Seq_raw="/path/to/nnSeq2Seq_raw"
export nnSeq2Seq_preprocessed="/path/to/nnSeq2Seq_preprocessed"
export nnSeq2Seq_results="/path/to/nnSeq2Seq_results"
```
...
```sh
git clone https://github.com/fiy2W/AsynDiff.git
cd AsynDiff
pip install -e .
```