...
class nnSeq2SeqPipeline(object):
    ...
    def predict_from_image_volume(self,
        ...
        prediction = self.predictor.predict_logits_from_preprocessed_data(data=data, properties=properties)
    ...
    def predict_from_image_slice_tensor(self,
        ...
        with torch.no_grad():
            ...
            prediction = self.predictor.network.infer_diffusion(data_in, src_code, num_inference_steps=1)
